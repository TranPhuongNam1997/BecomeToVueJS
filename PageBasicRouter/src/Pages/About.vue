<template>
    <div>
        <header-page
            linkimg="https://img1.kienthucvui.vn/uploads/2021/01/13/anh-ong-chu-han-quoc-dien-trai_023543370.jpg"
            title="About me"
            subbanner="Our mission is to make building websites easier for everyone."
        />
        <header class="py-5">
